...
// Grupo de Exercícios 2 Exercício 2
...
public class Exercise2 {
    ...
    class Counter {
        ...
        // Synchronized method to ensure safe access of multiple threads
        void increment(){
            synchronized (this) {
            counter++;
            }
        ...
        // Synchronized method to ensure correct reading of the value
        int getCounter(){
            synchronized (this){
                return counter;
            }
